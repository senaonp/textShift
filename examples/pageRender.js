...
var content = `<p class='examples_description'>textShift videos demonstrating example applications of textshift.net</p><div id='textshift_videos'><small class='mini_desc'>decoding textShift examples #1-#5</small><div class="preview" onclick="navi('https://fbacarisas.xyz/video/#textshift_examples_5')"><img src="../assets/textshift_examples_5.jpg" /><p>[ senaonp Channel ] decoding textShift examples (#1-#5)<br><span class='link_preview'>decoding the ciphertext examples in textShift.net</span></p></div><br><small class='mini_desc'>using sequencing ciphers for encoding and decoding</small><div class="preview" onclick="navi('https://fbacarisas.xyz/video/#textshift_sequencing_demo')"><img src="../assets/textshift_sequencing_demo.jpg" /><p>[ senaonp Channel ] textshift.net sequencing ciphers demo<br><span class='link_preview'>demonstrating encoding text using 5 sequencing ciphers and then decoding the ciphertext using the website, textshift.net</span></p></div></div>`;
content += "<p class='examples_description'>this section contains examples of ciphertext produced using textShift. the decoded ciphertext and ciphers used can be displayed using the button in each example.<br><br>to decode the ciphertext, apply the decoding ciphers in reverse order from the example; the examples have the ciphers in the order in which they were applied for encoding<br><br>some ciphertext may not be rendered in the browser due to unicode characters; links are included in each example to the original textfile</p>";
