...
content += `<small class='mini_desc'>textShift video on decoding examples #1-#5</small><div class="preview" onclick="navi('https://fbacarisas.xyz/video/#textshift_examples_5')"><img src="../assets/textshift_examples_5.jpg" /><p>[ senaonp Channel ] decoding textShift examples (#1-#5)<br><span class='link_preview'>decoding the ciphertext examples in textShift.net</span></p></div><br><small class='mini_desc'>textShift video on using sequencing ciphers for encoding and decoding</small><div class="preview" onclick="navi('https://fbacarisas.xyz/video/#textshift_sequencing_demo')"><img src="../assets/textshift_sequencing_demo.jpg" /><p>[ senaonp Channel ] textshift.net sequencing ciphers demo<br><span class='link_preview'>demonstrating encoding text using 5 sequencing ciphers and then decoding the ciphertext using the website, textshift.net</span></p></div>`;
